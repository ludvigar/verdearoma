...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="{{ route ('admin.dashboard') }}" title="Inicio" class="tip-bottom"><i class="icon-home"></i> Panel de Control</a> <a href="{{ route ('admin.categories.index') }}" class="tip-bottom">Categorías</a> 
			<a class="current"> Editar Categoría</a>
		</div>
